...
import com.quang.lilianachat.adapter.StrangerAdapter;
...
public class StrangerFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new StrangerAdapter(listUser);
        rvStranger.setAdapter(adapter);

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference mRef = database.getReference("list_user");
        mRef.orderByChild("countStranger").addChildEventListener(new ChildEventListener() {
            @Override
